  ...
  return (
    <div id="HeroSection" className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        Empower your creativity and bring your VR app ideas to life with our intuitive development tools. Get started tody and turn your imagination into immersive reality!
      </p>
